    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Check traffic vehicles so as to not to collide with them
          ...
          //use previous paths endpont as starting reference  
          if (prev_size < 2)
          {
          ...
          const vector<double> next_wp0{getXY(car_s + 30., (2. + 4. * lane), map_waypoints_s, map_waypoints_x, map_waypoints_y)};
          const vector<double> next_wp1{getXY(car_s + 60., (2. + 4. * lane), map_waypoints_s, map_waypoints_x, map_waypoints_y)};
          const vector<double> next_wp2{getXY(car_s + 90., (2. + 4. * lane), map_waypoints_s, map_waypoints_x, map_waypoints_y)};
          ...
          /* shift car's ref angle to 0 degree */
